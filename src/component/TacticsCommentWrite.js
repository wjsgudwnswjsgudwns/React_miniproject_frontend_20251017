...
import "./TacticsCommentWrite.css";

function TacticsCommentWrite({ loadComment, boardId, user }) {
  ...
  const handleComment = async (e) => {
    ...
    try {
      await api.post(`/api/tactics/comment/${boardId}`, {
        content: newComment,
      });
      setNewComment("");
      loadComment();
...
export default TacticsCommentWrite;
